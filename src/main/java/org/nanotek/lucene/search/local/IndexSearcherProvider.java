...
//import org.nanotek.cms.domain.lucene.config.IndexType;
//import org.nanotek.cms.domain.lucene.config.Store;
...
public class IndexSearcherProvider extends LuceneSearcherProvider {
	 ...
	 * Index Store HashSet. 
	 * 
	 * TODO: Fix on future to store the loop on several Stores. 
	 * For Now retrieves the first Store on Index Object.
	 * 
	 */
...
//						}
		...
		//TODO: remove the lock. btw what was the idea?
